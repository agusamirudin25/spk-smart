            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Ubah Data Kuesioner</h4>
                    </div>
                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-row">
                                            <?php foreach ($options as $key_opsi => $opsi) : ?>
                                                <div class="col">
                                                    <div class="radio">
                                                        <input type="radio" <?= ($opsi['nilai'] == $row['nilai']) ? 'checked' : null ?> name="jawaban_<?= $key + 1 ?>" id="radio<?= $key . $key_opsi ?>" value="<?= $opsi['nilai'] ?>" required>
    ...
    <script>
        $(document).ready(function() {
            $('#formUbah').submit(function(e) {
                ...
                $.ajax({
                    url: '<?= url(); ?>kuesioner/proses_ubah_kuesioner',
                    type: "post",
                    data: data,
                    processData: false,
                    contentType: false,
