                        ...
                        <div class="card-body">
                            <form autocomplete="off" id="formUbah">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="number" value="<?= $kriteria->bobot ?>" placeholder="Contoh : 2 (nilai antara 1 sampai 10)" name="bobot" id="bobot" required>
                                        <span>Contoh : 2 (nilai antara 1 sampai 10)</span>
                                    </div>
                                </div>
