                        ...
                        <div class="card-body">
                            <form autocomplete="off" id="formTambah">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" readonly value="<?= $kode_otomatis ?>" name="kode_kriteria" id="kode_kriteria" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="nama_kriteria" class="col-sm-2 col-form-label">Nama Kriteria</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="Masukan Nama Kriteria" name="nama_kriteria" id="nama_kriteria" required>
                                    </div>
                                </div>
                                <div class="form-group row">
    ...
    <script>
        $(document).ready(function() {
            $('#formTambah').submit(function(e) {
                ...
                $.ajax({
                    url: '<?= url(); ?>kriteria/proses_tambah_kriteria',
                    type: "post",
                    data: data,
                    processData: false,
                    contentType: false,
